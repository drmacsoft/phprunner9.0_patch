...
var MONTH_NAMES = ['ÝÑæÑÏíä', 'ÇÑÏíÈåÔÊ', 'ÎÑÏÇÏ', 'ÊíÑ', 'ÇãÑÏÇÏ', 'ÔåÑíæÑ', 'ãåÑ', 'ÂÈÇä', 'ÂÐÑ', 'Ïí', 'Èåãä', 'ÇÓÝäÏ'];
var ABBR_DAYS = ['?Ô', '?Ô', '?Ô', '?Ô', '?Ô', 'Ì', 'Ô'];
var DAYS_NAMES = ['í˜ÔäÈå', 'ÏæÔäÈå', 'ÓåÔäÈå', 'åÇÑÔäÈå', 'äÌÔäÈå', 'ÌãÚå', 'ÔäÈå'];
